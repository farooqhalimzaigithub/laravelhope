                           ...
                           <div class="col-xl-4">
                            ...
                            <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                              <div class="card-body">
                                ...
                                <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3">{{$staff_count_att_p}}</div>
                                <a href="#" class="text-inverse-primary text-hover-primary font-weight-bold font-size-lg mt-1">Present Teachers</a>
                              </div>
                            </div>
                            <!--end::Tiles Widget 12-->
                          </div>
                           ...
                           <div class="col-xl-4">
                            ...
                            <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                              <div class="card-body">
                                ...
                                <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3">{{$staff_count_att_a}}</div>
                           ...
                           <div class="col-xl-4">
                            ...
                            <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                              <div class="card-body">
                                ...
                                <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3">{{$student_count_att_p}}</div>
                           ...
                           <div class="col-xl-4">
                            ...
                            <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                              <div class="card-body">
                                ...
                                <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3">{{$student_count_att_a}}</div>
