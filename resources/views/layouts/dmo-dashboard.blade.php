               ...
               <div class="col-lg-12 col-xxl-4" >
                  ...
                  <div class="card card-custom bg-gray-100 card-stretch gutter-b" >
                     ...
                     <div class="card-header border-0 bg-primary py-5">
                       <h3 class="card-title font-weight-bolder text-white">DMO Dashboard</h3>
                       <div class="card-toolbar">
                        <div class="dropdown dropdown-inline">
                           <!-- <a href="#" class="btn btn-transparent-white btn-sm font-weight-bolder dropdown-toggle px-5" >DMO Dashboard</a> -->
                  ...
                  <div class="card-body p-0 position-relative overflow-hidden " >
                     ...
                     <div id="kt_mixed_widget_1_chart" class="card-rounded-bottom bg-primary" style="height: 200px">
                        <!-- ================new================== -->
                        <div class="col-12 ">
                         <div class="widget widget-chart-two h-60">
                           <div class="widget-heading d-flex" style="justify-content: space-between">
                             <a href="./students/GCSAttendance.php" class="btn btn-light col-2 px-0"  style="color: black;">Attendance</a>
                             <a href="#" class="btn btn-light col-2" style="color: black;">Student List</a>
                             <a href="./schools/AddnewSchool.php" class="btn btn-light col-2" style="color: black;">Add School</a>
                             <a href="./teachers/AddTeachers.php" class="btn btn-light col-2" style="color: black;"> Teachers</a>
                             <a href="./report.php" class="btn btn-light col-2" style="color: black;">Reports</a>
                          </div>
                       </div>
                    </div>
                 </div>
                 ...
                 <div class="card-spacer mt-n35">
                  ...
                  <div class="row m-0">
                     <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                        ...
                        <a href="#" class="text-warning font-weight-bold font-size-h6">Faculty | Staff</a>
                     </div>
                     <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                        ...
                        <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Total Students</a>
                     </div>
                  </div>
                  <!--end::Row-->
                  <!--begin::Row-->
                  <div class="row m-0">
                     <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                        ...
                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Total Tadad  </a>
                     </div>
                     <div class="col bg-light-success px-6 py-8 rounded-xl">
                        ...
                        <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Schools</a>
                     </div>
                  </div>
                  <!--end::Row-->
               </div>
         ...
         <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-body pt-0">
               ...
               <div class="col-12 my-3 d-flex">
                ...
                <a href="#" class="ml-auto"><button class="btn btn-primary">View All</button></a>
                <a href="#" class="ml-auto"><button class="btn btn-primary">Send Report</button></a>
                <a href="#" class="ml-auto"><button class="btn btn-primary">Contact Teachers</button></a>
             </div>
