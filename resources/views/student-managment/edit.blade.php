					...
					<form class="form  mt-2 "  method="post" action="{{route('students.update',$student->id)}}"  enctype="multipart/form-data" >
							...
							<div class="col-lg-9" style="float: left; " >
								...
								<div class="form-row">
									<div class="form-group col-lg-4">
										...
										<input type="text" value="{{$student->name}}" name="name" class="form-control" id="inputCity" required="">
									</div>
									<div class="form-group col-lg-4">
								...
								<div class="col-xl-3 ">
									...
									<div class="form-group" >
										...
										<label >
											...
											<p><input type="file"  accept="image/*" name="image" id="file" value="{{$student->image}}"  onchange="loadFile(event)" style="display: none;"></p>
						...
						<div class="row">
							...
							<div class="form-group col-lg-3">
								...
								<input type="text" name="father_cnic_no" class="form-control" value="{{$student->father_cnic_no}}" id="father_cnic">
							</div>
							<div class="form-group col-lg-3">
								<label for="inputState">Father Occupation</label>
								<input class="form-control "  name="father_occupation" value="{{$student->father_occupation}}"  placeholder="Father Occupation" />	
							</div>
						</div>
						<hr>
						...
						<div class="row">
							...
							<div class="form-group col-lg-3">
								...
								<input type="text" name="guardian_cnic_no" class="form-control" value="{{$student->guardian_cnic_no}}" id="guardian_cnic_no">
							</div>
						</div>
						<div class="row">
							<div class="form-group col-lg-3">
							...
							<div class="form-group">
								...
								<select class="form-control  tehsil_id"   name="tehsil_id" id="tehsil_id">
										  ...
										  @if($tehsil->id==$student->tehsil_id)
						...
						<div class="row">
							<div class="form-group col-lg-3">
								...
								<input type="date" name="date_of_admission" value="{{$student->date_of_admission}}" class="form-control" id="inputCity" required="">
							</div>
							<div class="form-group col-lg-3">
							...
							<div class="form-group col-lg-3">
								...
								<select class="form-control " required="true"  name="current_class_id">
									...
									@if($data->id==$student->current_class_id)
...
<div class="row">
	...
	<div class="form-group col-lg-4">
		...
		<textarea type="text" name="address" placeholder=" Addrss" value="{{$student->address}}" class="form-control" id="inputCity">{{$student->address}}</textarea>
	</div>
...
<div class="row">
	...
	<div class="form-group col-lg-4">
		...
		<textarea type="text" name="remark" placeholder="Describe Remarks" value="{{$student->remark}}" class="form-control" id="inputCity">{{$student->remark}}</textarea>
	</div>
</div>
